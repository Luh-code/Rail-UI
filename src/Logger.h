...
void rail_vlog(char* color, char* format, va_list args)
{
  printf("%s", color);
...
void rail_log(char* color, char* format, ...)
{
  va_list args;
...
void rail_log_neutral(char* format, ...)
{
  va_list args;
  va_start(args, format);
...
void rail_log_debug(char* format, ...)
{
  va_list args;
  va_start(args, format);
...
void rail_log_warn(char* format, ...)
{
  va_list args;
  va_start(args, format);
...
void rail_log_error(char* format, ...)
{
  va_list args;
  va_start(args, format);
